	...
	render () {
		...
		return (
			<div ref="body" style={{display: "none"}}>
				...
				<div>
					안녕하세요 Excel Merge Tool(엑셀머지툴) 입니다.<br/>
					엑셀머지툴은 하나의 엑셀 양식 파일을 여러 명이서 나눠서 협업할 때,<br/>
					매우 유용합니다. <br/>
					<br/>
					하나의 엑셀 파일을 여러 명이 공동 작업 해야할 때가 많습니다.<br/>
					- 테스트케이스를 가지고 여러 명이 QA를 진행할 경우<br/>
					- 데이터를 사람으로 나눈후, 한 가지 폼에 기록할 경우<br/>
					<br/>
					이때 엑셀머지툴을 사용한다면,<br/>
					작업 후, 파일을 하나로 합쳐주는 시간을 줄여줄 수 있습니다.<br/>
					100명이 100개의 파일을 만든다면, 100개의 파일을 열어서 합쳐줘야하지만!<br/>
					엑셀머지툴을 사용하면 1분만에 작업이 가능합니다.<br/>
					<br/>
					한번 써보시고 경험해보세요!<br/>
					감사합니다. :)<br/>
					<br/>
					만든이: seunggabi<br/>
					이메일: seunggabi@naver.com<br/>
					<br/>
				</div>
			</div>
		)
